...
export default {
    ...
    methods: {
        ...
        login: async function () {
            ...
            await axios.post(this.$root.api_path + 'auth/in', post)
                .then(async (r) => {
                    if (r.status) {
                        ...
                        localStorage.setItem('departemen_code', data.departemen_code)
                        localStorage.setItem('departemen_name', data.departemen_name)
                        loading.dismiss()
                        const toast = await toastController.create({
