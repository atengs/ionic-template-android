    ...
    <ion-page>
        <ion-content :fullscreen="true">
            ...
            <div id="container">
                ...
                <div id="data-profile">
                    <ion-item>
                        <ion-input label="NIK" label-placement="floating" v-model="nik" readonly></ion-input>
                    </ion-item>
                    <ion-item>
                        <ion-input label="Nama Lengkap" label-placement="floating" v-model="profile_name"></ion-input>
                    </ion-item>
                    <ion-item>
                        <ion-input label="Nomor Telepon" label-placement="floating" v-model="profile_phone"></ion-input>
                    </ion-item>
                    <ion-item>
                    ...
                    <ion-item>
                        <ion-textarea label="Alamat" label-placement="floating" :auto-grow="true"
                            v-model="profile_address"></ion-textarea>
                    </ion-item>

                    <ion-item>
                        <ion-input v-if="showPassword" label="Ubah Password" label-placement="floating" type="text"
                            v-model="password"></ion-input>
                        <ion-input v-else label="Ubah Password" label-placement="floating" type="password"
                            v-model="password"></ion-input>
...
<script>
/* eslint-disable */
import { IonPage, IonContent, IonIcon, IonInput, IonTextarea, IonButton, IonSelect, IonSelectOption, IonItem, IonLabel, useBackButton, useIonRouter, toastController, loadingController } from '@ionic/vue';
...
export default {
    ...
    methods: {
        ...
        fetchProfile() {
            return axios.get(this.$root.api_path + 'mst/user/getByUserId/' + localStorage.getItem('id'), {
                dataType: "json",
                headers: {
        ...
        submit: async function () {
            ...
            // console.log(post);
            // loading.dismiss();
            await axios.post(this.$root.api_path + 'mst/user/edit', post,
                {
                    headers: {
                        Authorization: 'bearer ' + localStorage.getItem('token')
                    }
...
#container #data-profile ion-item ion-input,
ion-select,
ion-textarea,
ion-icon {
    color: #5b5b5b;
