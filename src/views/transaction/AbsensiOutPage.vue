        ...
        <ion-content :fullscreen="true">
            ...
            <div id="dashboard-container">
                ...
                <div class="tx-center">
                    ...
                    <!-- <IonButton v-if="selfie != null && locate != null && accept_distance == true" type="button"
                        @click="absen">Pulang</IonButton> -->
                </div>
            </div>
...
export default {
    props: [],
    components: { IonContent, IonPage, IonButton, IonIcon, IonInput },
    data() {
        return {
    ...
    methods: {
        getSite() {
            return axios.get(this.$root.api_path + 'mst/masterDepartemen/getByDepartemenCode/' + localStorage.getItem('departemen_code'))
                .then(async (response) => {
                    ...
                    // console.log(this.site_lat);
                    // console.log(this.site_long);
        ...
        getJadwal() {
            ...
            return axios.post(this.$root.api_path + 'trx/attendee/getScheduleOut', post)
                .then((response) => {
                    // binding data
                    const data = response.data.data;
