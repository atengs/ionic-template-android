    ...
    methods: {
            ...
            axios.get(this.imgDocs, { responseType: "blob" })
                .then(async function (response) {
                    ...
                    reader.onloadend = function () {
                        ...
                        axios.post(this.$root.api_path + 'trx/absence/upload', post)
                            .then((res) => {
                                loading.dismiss();
                                // console.log(res)
                            })
        ...
        getHoliday() {
            if (this.startDate != null && this.endDate != null) {
                ...
                return axios.post(this.$root.api_path + 'trx/holiday/getByDateRange', post)
                    .then((response) => {
                        const data = response.data.data;
                        data.forEach(item => {
        ...
        getJenis() {
            return axios.get(this.$root.api_path + 'mst/masterAbsence/getCuti', { dataType: "json" })
                .then((response) => {
                    // binding data
                    const data = response.data.data;
                    data.forEach(item => {
        ...
        submit: async function () {
            ...
            await axios.post(this.$root.api_path + 'trx/absence/add', post)
                .then(async (res) => {
                    if (res.status) {
                        const toast = await toastController.create({
